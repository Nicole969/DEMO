...
return [
    ...
    */
    ...
    'title' => '',
    'title_prefix' => 'Multiservicios Garay | ',
    'title_postfix' => '',
    ...
    */
    ...
    'logo' => '<b>Multiservicios</b> Garay',
    'logo_img' => 'vendor/adminlte/dist/img/logo.png',
    'logo_img_class' => 'brand-image img-circle elevation-3',
    'logo_img_xl' => null,
    'logo_img_xl_class' => 'brand-image-xs',
    'logo_img_alt' => 'Multiservicios Garay',
    ...
    */
    ...
    'menu' => [
        ...
        [
            ...
            'icon_color' => 'warning',
            'route'          => 'usuario.clientesU.index',
            'active'  =>['admin/clientesU*'],
        ],
        [
            'text' => 'Ventas',
            'icon'        => 'fas fa-fw fa-cash-register',
            'icon_color' => 'red',
            'route'          => 'usuario.ventasU.index',
            'active'  =>['admin/ventasU*'],
        ],
        [
            'text' => 'Citas',
            'icon'        => 'fas fa-fw fa-calendar-alt',
            'icon_color' => 'info',
            'route'          => 'usuario.citasU.index',
            'active'  =>['admin/citasU*'],
        ],

    
        // Sidebar items:
        ['header' => 'ADMINISTRACION', 'can'  => 'admin.ventas.index',],
        ...
        ['header' => 'AJUSTES', 'can'  => 'admin.users.index', ],
        
        [
            'text' => 'Roles de usuraios',
