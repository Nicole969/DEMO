...
<div class="w-full lg:w-12/12 bg-white p-3 rounded-lg lg:rounded-l-none"> 
  <div class="font-medium pt-0 text-center text-xl sm:text-3lg text-blue-800">
      Editando el detalle de compras 👀😄
  </div>
  </div>
@stop
...
<div class="card">
  <div class="card-body">
    ...
    {!! Form::model($detallecompra, ['route' => ['admin.detallecompras.update', $detallecompra], 'method' =>'put']) !!}
    @endforeach
    ...
    href="{{ route('admin.detallecompras.index') }}" 
