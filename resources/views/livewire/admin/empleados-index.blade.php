<div>
    ...
    <div class="text-center flex justify-between"> 
      ...
      transition-all duration-150" href="{{ route('admin.empleados.create') }}" 
      class=" hover:text-indigo-900">Agrear nueva Empleados</a>
    </div>
    </div> 
    ...
    ease-linear transition-all duration-150" href="{{ route('epdf') }}" 
  ...
  @if($empleados->count())
        ...
        <tbody class="bg-white divide-y divide-blue-200">
          ...
          <td class="px-6 py-4 whitespace-nowrap">
          <div class="text-sm text-blue-900">{{$empleado->apellido_paterno}}</div>
          <div class="text-sm text-blue-500">{{$empleado->apellido_materno}}</div>
          </td>
          ...
          <td class="px-6 py-4 whitespace-nowrap">
          <div class="text-sm text-blue-900">{{$empleado->edad}}</div>
          <div class="text-sm text-blue-500">{{$empleado->DNI}}</div>
          </td>
        
          <td class="px-6 py-4 whitespace-nowrap">
            <div class="text-sm text-blue-900">{{$empleado->celular}}</div>
            <div class="text-sm text-blue-500">{{$empleado->correo}}</div>
          </td>
          ...
          <a href="{{ route('admin.empleados.edit', $empleado) }}" class="text-blue-600 hover:text-blue-900">Edit</a>
          </td>
